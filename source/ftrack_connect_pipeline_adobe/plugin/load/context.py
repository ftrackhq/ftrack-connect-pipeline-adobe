...
class AdobeLoaderContextPlugin(plugin.LoaderContextPlugin, AdobeBasePlugin):
...
class AdobeLoaderContextPluginWidget(
    pluginWidget.LoaderContextPluginWidget, AdobeBasePluginWidget
):
