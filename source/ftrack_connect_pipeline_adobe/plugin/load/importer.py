...
class AdobeLoaderImporterPlugin(plugin.LoaderImporterPlugin, AdobeBasePlugin):
...
class AdobeLoaderImporterPluginWidget(
    pluginWidget.LoaderImporterPluginWidget, AdobeBasePluginWidget
):
