...
class AdobePublisherContextPlugin(
    plugin.PublisherContextPlugin, AdobeBasePlugin
):
...
class AdobePublisherContextPluginWidget(
    pluginWidget.PublisherContextPluginWidget, AdobeBasePluginWidget
):
